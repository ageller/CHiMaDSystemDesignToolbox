...
function resize(){
	...
	if ((params.answersGroupnames.para.includes(params.groupname) && params.paraSubmitted2 && params.haveSDC) || params.haveParaEditor || params.haveSDCEditor) createSystemDesignChart();
}